...
家計簿アプリLifeは、ライフゲージを使ってわかりやすく支出と収入を管理できる家計簿アプリです。
# 制作しようと思ったきっかけ
従来の家計簿アプリは、金額だけしか表示されないので、自分が全体の金額の何割使ったのかが、わかりにくい。その問題を解決するために、
ライフゲージを使うことで、自分がどのぐらいの割合を使っているのかが、わかるようにしたかったからです。
# 特にこだわったところ
ライフゲージを大きく表示して、自分がどれぐらい使ったのかが、すぐにわかるようにこだわりました。
# 特に苦労したこと
同じ年と月ごとに支出と収入を分けて、収入が多ければ、残高に足す、収入が支出より少なかったら、その分を残高から引く処理の実装がとても苦労しました。
